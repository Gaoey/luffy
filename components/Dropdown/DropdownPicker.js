...
class DropDownPicker extends React.Component {
  ...
  render() {
    this.props.controller(this);
    const { clearTextAction } = this.props
    ...
    const label = (clearTextAction || isPlaceholderActive) ? (placeholder) : this.getLabel(this.state.choice?.label, true);
